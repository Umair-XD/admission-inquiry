...
<!-- =============================
     TITLE
============================= -->
<h2 class="text-center fw-bold my-4">Top Highlights</h2>
<!-- =============================
     TOP HIGHLIGHTS ROWS
============================= -->
<div class="row g-4">
...
<!-- =============================
     WHAT'S ON SLIDER
============================= -->
<h2 class="text-center fw-bold my-4">What's On</h2>
...
<!-- =============================
     RECTOR MESSAGE
============================= -->
<h2 class="text-center fw-bold my-4">Rector's Message</h2>
...
<!-- =============================
     SCHOLARSHIPS
============================= -->
<h2 class="text-center fw-bold my-4">Scholarships</h2>
