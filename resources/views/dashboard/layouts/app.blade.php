...
<!-- DataTables -->
<script src="{{ asset('vendor/datatables/js/jquery.dataTables-1.13.6.min.js') }}"></script>
<script src="{{ asset('vendor/datatables/js/dataTables.bootstrap5-1.13.6.min.js') }}"></script>
<!-- SweetAlert2 -->
